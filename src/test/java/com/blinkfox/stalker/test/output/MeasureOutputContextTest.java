...
public class MeasureOutputContextTest {
    ...
    public void outputWithoutOutputs() {
        ...
        new MeasureOutputContext().output(Options.of().outputs(outputs), new StatisResult());
        new MeasureOutputContext().output(Options.of().outputs(new ArrayList<>()), new StatisResult());
    }
